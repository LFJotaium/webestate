...
class HouseOnboardingScreen extends StatefulWidget {
  @override
  _HouseOnboardingScreenState createState() =>
      _HouseOnboardingScreenState();
}
...
class _HouseOnboardingScreenState extends State<HouseOnboardingScreen>
  ...
  final TextEditingController _locationLatLngController = TextEditingController();
  ...
  final TextEditingController _totalBathroomsController = TextEditingController();
  final TextEditingController _totalKitchensController = TextEditingController();
    ...
    try {
      ...
      if (_images.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context).add_apartment_photosRequired),
      ...
      if (_titleController.text.isEmpty ||
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context).add_apartment_requiredFields),
            backgroundColor: Colors.red,
          ),
        );
        return;
      ...
      await addHouse(
        ...
        images: _images,
        videoTourUrl: _videoUrlController.text.isNotEmpty ? _videoUrlController.text : null,
        area: double.parse(_areaController.text),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${AppLocalizations.of(context).add_apartment_addError} ${e.toString()}'),
          backgroundColor: Colors.red,
        ),
      );
              ...
              child: PageView(
                ...
                children: [
                  BasicInfoStep(
                    ...
                    listingType: _listingType,
                    onListingTypeChanged: (value) => setState(() => _listingType = value!),
                  ),
                  LocationStep(
                    fadeAnimation: _fadeAnimation,
                  ...
                  HouseFeaturesStep(
                    ...
                    onFeatureChanged: (feature, value) {
                      setState(() {
                        switch (feature) {
                          case 'balcony': _hasBalcony = value; break;
                          case 'parking': _hasParking = value; break;
                          case 'elevator': _hasElevator = value; break;
                          case 'storage': _hasStorage = value; break;
                          case 'ac': _hasAirConditioning = value; break;
                          case 'furnished': _isFurnished = value; break;
                          case 'utilities': _utilitiesIncluded = value; break;
                        }
                      });
                    },
                  ),
                ...
                children: [
                  if (_currentStep > 0)
                    ElevatedButton(
                      ...
                      child: Text(AppLocalizations.of(context).add_apartment_back),
