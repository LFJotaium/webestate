...
class ApartmentOnboardingScreen extends StatefulWidget {
  @override
  _ApartmentOnboardingScreenState createState() =>
      _ApartmentOnboardingScreenState();
}

class _ApartmentOnboardingScreenState extends State<ApartmentOnboardingScreen>
  ...
  Future<void> _submitForm() async {
    try {
      ...
      try {
        ...
        floor = double.parse(_floorController.text);
      } catch (e) {
