...
class ApartmentDetailsStep extends StatelessWidget {
              ...
              children: [
                Expanded(
                  child: _buildAnimatedTextField(
                    ...
                    label: AppLocalizations.of(context).add_apartment_floor,
                    icon: Icons.apartment,
                    keyboardType: TextInputType.number,
                  ).animate().slideX(delay: 300.ms, begin: 0.1, end: 0),
                ),
                SizedBox(width: 16),
                Expanded(
                  child: _buildAnimatedTextField(
                    ...
                    label: AppLocalizations.of(context).add_apartment_totalFloors,
                    icon: Icons.stairs,
                    keyboardType: TextInputType.number,
                  ).animate().slideX(delay: 400.ms, begin: 0.1, end: 0),
                ),
              ],
            ),
          ],
