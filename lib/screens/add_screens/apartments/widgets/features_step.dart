...
class ApartmentFeaturesStep extends StatelessWidget {
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                FeatureChip(
                  label: AppLocalizations.of(context).add_apartment_wifi,
                  icon: Icons.wifi,
                  selected: hasWifi,
                  onSelected: (selected) => onFeatureChanged('wifi', selected),
                ),
                FeatureChip(
                  label: AppLocalizations.of(context).add_apartment_pool,
                  icon: Icons.pool,
                  selected: hasPool,
                  onSelected: (selected) => onFeatureChanged('pool', selected),
                ),
                FeatureChip(
                  label: AppLocalizations.of(context).add_apartment_gym,
                  icon: Icons.fitness_center,
                  selected: gymNearby,
                  onSelected: (selected) => onFeatureChanged('gym', selected),
                ),
                FeatureChip(
