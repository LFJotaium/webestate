...
class InfoCardSection extends StatelessWidget {
  ...
  const InfoCardSection({super.key, required this.land});
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      InfoItem(
                        icon: Iconsax.money,
                        value: "${EstateRepository().formatNumber(land.price.toInt())} ₪",
                        label: "السعر",
                        isWeb: isWeb,
                      ),
                      InfoItem(
                        icon: Iconsax.ruler,
                        value: "${land.area.toInt()} متر²",
                        label: "المساحة",
                        isWeb: isWeb,
                      ),
                      InfoItem(
                        icon: Iconsax.buildings,
                        value: land.listingType == 'rent' ? 'للإيجار' : 'للبيع',
                        label: "النوع",
                        isWeb: isWeb,
                      ),
                    ],
