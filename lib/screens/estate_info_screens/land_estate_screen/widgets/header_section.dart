...
class HeaderSection extends StatefulWidget {
  ...
  const HeaderSection({super.key, required this.land});
...
class _HeaderSectionState extends State<HeaderSection> {
  ...
  void dispose() {
    ...
    widget.land.images.forEach((url) {
  ...
  Widget build(BuildContext context) {
    ...
    final hasMultipleImages = widget.land.images.length > 1;
              ...
              child: Stack(
                children: [
                  PageView.builder(
                    ...
                    itemCount: widget.land.images.length,
                    onPageChanged: (index) => setState(() => _currentPage = index),
                    itemBuilder: (context, index) {
                      return CachedNetworkImage(
                        imageUrl: widget.land.images[index],
                        fit: BoxFit.cover,
                  ...
                  // Right arrow
                  if (_showArrows && _currentPage < widget.land.images.length - 1)
                    Positioned(
                      right: 20,
                      top: 0,
                      bottom: 0,
                  ...
                  Positioned(
                    ...
                    child: Center(
                      child: SmoothPageIndicator(
                        controller: _pageController,
                        count: widget.land.images.length,
                  ...
                  // Video tour button
                  if (widget.land.videoTourUrl.isNotEmpty)
                    Positioned(
                      bottom: 16,
                      right: isWeb ? 32 : 16,
                      child: GestureDetector(
                        onTap: () => _launchVideoTour(widget.land.videoTourUrl),
                        child: Container(
