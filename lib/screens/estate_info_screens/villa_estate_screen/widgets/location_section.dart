...
class LocationSection extends StatelessWidget {
  ...
  const LocationSection({super.key, required this.villa});
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => _openMaps(villa.latitude, villa.longitude),
                      child: Text(
                        "فتح في الخريطة",
                        style: GoogleFonts.cairo(
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: FlutterMap(
                    options: MapOptions(
                      initialCenter: LatLng(villa.latitude, villa.longitude),
                      initialZoom: 10.0,
                    ),
                    children: [
                      TileLayer(
                      ...
                      MarkerLayer(
                        markers: [
                          Marker(
                            point: LatLng(villa.latitude, villa.longitude),
                            child: const Icon(
                              Icons.location_pin,
                              color: Colors.red,
                              size: 40,
