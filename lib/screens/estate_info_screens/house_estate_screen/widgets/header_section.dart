...
class HeaderSection extends StatefulWidget {
  ...
  const HeaderSection({super.key, required this.house});
...
class _HeaderSectionState extends State<HeaderSection> {
  ...
  void dispose() {
    ...
    widget.house.images.forEach((url) {
  ...
  Widget build(BuildContext context) {
    ...
    final hasMultipleImages = widget.house.images.length > 1;
            ...
            child: MouseRegion(
              ...
              child: Stack(
                children: [
                  PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return CachedNetworkImage(
                        imageUrl: widget.house.images[index],
                        fit: BoxFit.cover,
                  ...
                  // Right arrow
                  if (_showArrows && _currentPage < widget.house.images.length - 1)
                    Positioned(
                      right: 20,
                      top: 0,
                      bottom: 0,
                  ...
                  // Video tour button
                  if (widget.house.videoTourUrl.isNotEmpty)
                    Positioned(
                      bottom: 16,
                      right: isWeb ? 32 : 16,
                      child: GestureDetector(
                        onTap: () => _launchVideoTour(widget.house.videoTourUrl),
                        child: Container(
