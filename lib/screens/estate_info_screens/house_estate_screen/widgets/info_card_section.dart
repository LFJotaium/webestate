...
class InfoCardSection extends StatelessWidget {
  ...
  const InfoCardSection({super.key, required this.house});
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      InfoItem(
                        icon: Iconsax.money,
                        value: "${EstateRepository().formatNumber(house.price.toInt())} ₪",
                        label: "السعر",
                        isWeb: isWeb,
                      ),
                      InfoItem(
                        icon: Iconsax.ruler,
                        value: "${house.area.toInt()} متر²",
                        label: "المساحة",
                        isWeb: isWeb,
                      ),
                      InfoItem(
                        icon: Iconsax.buildings,
                        value: house.listingType == 'rent' ? 'للإيجار' : 'للبيع',
                        label: "النوع",
                        isWeb: isWeb,
                      ),
                    ],
