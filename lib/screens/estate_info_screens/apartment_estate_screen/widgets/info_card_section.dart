...
class InfoCardSection extends StatelessWidget {
  ...
  const InfoCardSection({super.key, required this.apartment});
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      InfoItem(
                        icon: Iconsax.money,
                        value: "${EstateRepository().formatNumber(apartment.price.toInt())} ₪",
                        label: "السعر",
                        isWeb: isWeb,
                      ),
                      InfoItem(
                        icon: Iconsax.ruler,
                        value: "${apartment.area.toInt()} متر²",
                        label: "المساحة",
                        isWeb: isWeb,
                      ),
                      InfoItem(
                        icon: Iconsax.buildings,
                        value: apartment.listingType == 'rent' ? 'للإيجار' : 'للبيع',
                        label: "النوع",
                        isWeb: isWeb,
                      ),
                    ],
