...
class HeaderSection extends StatefulWidget {
  ...
  const HeaderSection({super.key, required this.apartment});
...
class _HeaderSectionState extends State<HeaderSection> {
  ...
  void dispose() {
    ...
    widget.apartment.images.forEach((url) {
  ...
  Widget build(BuildContext context) {
    ...
    final hasMultipleImages = widget.apartment.images.length > 1;
            ...
            child: MouseRegion(
              ...
              child: Stack(
                children: [
                  PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return CachedNetworkImage(
                        imageUrl: widget.apartment.images[index],
                        fit: BoxFit.cover,
                  ...
                  // Right arrow
                  if (_showArrows && _currentPage < widget.apartment.images.length - 1)
                    Positioned(
                      right: 20,
                      top: 0,
                      bottom: 0,
                  ...
                  // Video tour button
                  if (widget.apartment.videoTourUrl.isNotEmpty)
                    Positioned(
                      bottom: 16,
                      right: isWeb ? 32 : 16,
                      child: GestureDetector(
                        onTap: () => _launchVideoTour(widget.apartment.videoTourUrl),
                        child: Container(
